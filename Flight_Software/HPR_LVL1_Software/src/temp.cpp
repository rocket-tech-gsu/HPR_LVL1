...
// float currMean = 0.0;
// float prevMean = 0.0;
// float currAltitudeArray[N]; // Using N
// float prevAltitudeArray[N]; // Using N
// float pressure;
// float bmpAltitude;
// float temperature;
...
//         sdCard.appendFile("/data.csv", dataString);
//     }
...
//     if (indexer < 2 * M) {
//             if (indexer < M) {
//                 prevLandingArray[landingIndex] = bmpAltitude;
//             }
//             else if (indexer >= M) {
//                 currLandingArray[landingIndex] = bmpAltitude;
//             }

//             if (indexer < N) {
//                 prevAltitudeArray[index] = bmpAltitude;
//             }
//             else if (indexer >= N && indexer < N * 2) {
//                 currAltitudeArray[index] = bmpAltitude;
//         }
//     }
//     else {
...
//             float diff = bmpAltitude - currLandingMean;
...
//         for (int i = 0; i < N; i++) {
//             currMean += currAltitudeArray[i];
//             prevMean += prevAltitudeArray[i];
//         }
        
//         // Apogee and flight detection
//         prevAltitudeArray[index] = currAltitudeArray[index];
//         currAltitudeArray[index] = bmpAltitude;
